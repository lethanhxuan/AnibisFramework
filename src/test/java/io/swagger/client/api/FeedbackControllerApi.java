...
import io.swagger.client.model.FeedbackDto;
...
public class FeedbackControllerApi {
   ...
   * @return Object
   */
  public Object feedbackControllerPost (FeedbackDto feedback) throws ApiException {
    Object postBody = feedback;
    byte[] postBinaryBody = null;
    
     // verify the required parameter 'feedback' is set
     if (feedback == null) {
        throw new ApiException(400, "Missing the required parameter 'feedback' when calling feedbackControllerPost");
     }
     
    // create path and map variables
    String path = "/v1/Feedback".replaceAll("\\{format\\}","json");
